---
name: remotion
description: Guidance for working in the Remotion monorepo (remotion-dev/remotion). Use when contributing to Remotion itself — covers Bun-based setup, build/test/lint commands via Turbo, PR title conventions, pre-commit checks, and how to run Remotion Studio, the Player testbed, the docs site, and CLI renders from packages/example. Mirrors https://github.com/remotion-dev/remotion/blob/main/AGENTS.md.
---
...
Read the full [contribution guide](https://github.com/remotion-dev/remotion/blob/main/packages/docs/docs/contributing/index.mdx).

- [General information](https://github.com/remotion-dev/remotion/blob/main/packages/docs/docs/contributing/index.mdx)
- [Implementing a new feature](https://github.com/remotion-dev/remotion/blob/main/packages/docs/docs/contributing/feature.mdx)
- [Implementing a new option](https://github.com/remotion-dev/remotion/blob/main/packages/docs/docs/contributing/option.mdx)
